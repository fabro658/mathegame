  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 text-gray-900 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-8 relative z-10">
        <a
          href="/mobile/primaire-mobile/niveaux_mobile/niveau1_mobile/addition_mobile"
        ...
        <a
          href="/mobile/primaire/niveaux_mobile/niveau1_mobile/soustraction_mobile"
        ...
        <a
          href="/mobile/primaire/niveaux_mobile/niveau1_mobile/multiplication_mobile"
        ...
        <a
          href="/mobile/primaire/niveaux_mobile/niveau1_mobile/division_mobile"
