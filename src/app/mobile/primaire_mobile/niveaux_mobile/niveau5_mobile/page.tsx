...
export default function Page() {
  return (
    <div className="h-screen overflow-y-auto flex flex-col items-center text-white bg-[#081c34] p-4 relative font-fredoka">
      ...
      <h1 className="text-4xl font-bold mt-20 mb-12 text-center">Les Exposants</h1>
