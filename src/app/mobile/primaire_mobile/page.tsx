  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-blue-100 text-black-900 relative">
      ...
      <div className="flex flex-col gap-4 w-full px-4 sm:items-center sm:gap-4 sm:w-full sm:text-center sm:mt-8 md:absolute md:right-0 md:top-1/2 md:transform md:-translate-y-1/2 md:flex-col md:items-end md:w-auto z-0">
        <Link href="/primaire_mobile/niveaux_mobile/niveau1_mobile">
        ...
        <Link href="/primaire_mobile/niveaux_mobile//niveau2_mobile">
        ...
        <Link href="/primaire_mobile/niveaux_mobile//niveau3_mobile">
        ...
        <Link href="/primaire_mobile/niveaux_mobile//niveau4_mobile">
        ...
        <Link href="/primaire_mobile/niveaux_mobile//niveau5_mobile">
        ...
        <Link href="/primaire_mobile/niveaux_mobile//niveau6_mobile">
