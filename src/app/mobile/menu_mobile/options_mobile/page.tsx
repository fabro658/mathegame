...
export default function Option() {
  ...
  const handleMailto = () => {
    ...
    const body = `${formData.message}\n\n—\nDe: ${formData.nom} <${formData.email}>`;
    const mailtoLink = `mailto:exploremathgestion@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  ...
  return (
    ...
    <div className="fixed inset-0 overflow-y-auto bg-gray-100 text-gray-900 p-4">
      ...
      {/* Contenu */}
      <div className="max-w-4xl w-full mx-auto pt-20 pb-8">
        ...
        <section className="mb-12 bg-white p-6 rounded-lg shadow-lg">
          ...
          <ul className="list-disc pl-6 text-lg space-y-4">
            ...
            <li>
              ...
              &nbsp;À tous ceux qui souhaitent améliorer leurs compétences en mathématiques.
            </li>
            <li>
