    ...
    <div className="fixed inset-0 overflow-y-auto flex flex-col items-center bg-blue-100 text-black p-4">
      ...
      <div className="flex flex-col gap-6 mb-16">
        <Link
          ...
          className="w-64 sm:w-80 md:w-96 h-16 sm:h-20 rounded-full transition-colors flex items-center justify-center bg-white text-black hover:bg-gray-200 text-lg sm:text-xl font-bold"
        >
          Périmètre
        </Link>
