    ...
    <div className="fixed inset-0 overflow-y-auto bg-blue-100 text-black">
      ...
      <main className="min-h-screen flex flex-col items-center p-4 pt-24 pb-28 relative">
        ...
        <div className="flex flex-col gap-8 items-center w-full max-w-xl">
          <Link
            href="/mobile/secondaire_mobile/niveaux_mobile/niveau3_mobile/expo_mobile"
          ...
          <Link
            href="/mobile/secondaire_mobile/niveaux_mobile/niveau3_mobile/racine_mobile"
            className="w-80 sm:w-96 h-14 sm:h-16 px-8 sm:px-10 rounded-full transition-colors flex items-center justify-center bg-white text-black hover:bg-gray-200 text-lg sm:text-xl font-semibold"
          >
            Racine
          </Link>
          ...
          <Link
            href="/mobile/secondaire_mobile/niveaux_mobile/niveau3_mobile/expression_equivalente_mobile"
            className="w-80 sm:w-96 h-14 sm:h-16 px-8 sm:px-10 rounded-full transition-colors flex items-center justify-center bg-white text-black hover:bg-gray-200 text-lg sm:text-xl font-semibold"
          >
          ...
          <Link
            href="/mobile/secondaire_mobile/niveaux_mobile/niveau3_mobile/priooperation_mobile"
            className="w-80 sm:w-96 h-14 sm:h-16 px-8 sm:px-10 rounded-full transition-colors flex items-center justify-center bg-white text-black hover:bg-gray-200 text-lg sm:text-xl font-semibold"
          >
          ...
          <Link
            href="/mobile/secondaire_mobile/niveaux_mobile/niveau3_mobile/approx_mobile"
            className="w-80 sm:w-96 h-14 sm:h-16 px-8 sm:px-10 rounded-full transition-colors flex items-center justify-center bg-white text-black hover:bg-gray-200 text-lg sm:text-xl font-semibold"
          >
            Approximation
          </Link>
