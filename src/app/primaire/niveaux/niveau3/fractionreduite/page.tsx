                  ...
                  <div className="flex gap-8">
                    <button
                      className={`py-2 px-4 rounded font-bold ${
                        answers[currentPage * questionsPerPage + index] === "greater"
                          ? "bg-orange-500 text-white"
                          : "bg-blue-500 text-white"
                      }`}
                      onClick={() =>
                        handleAnswer(currentPage * questionsPerPage + index, "greater")
                      }
                    >
                      Vrai
                    </button>
                    <button
                      className={`py-2 px-4 rounded font-bold ${
                        answers[currentPage * questionsPerPage + index] === "less"
                          ? "bg-orange-500 text-white"
                          : "bg-blue-500 text-white"
                      }`}
                      onClick={() =>
                        handleAnswer(currentPage * questionsPerPage + index, "less")
                      }
                    >
                      Faux
                    </button>
