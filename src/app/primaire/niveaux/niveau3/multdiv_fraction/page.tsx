      ...
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <a
            ...
            className="bg-red-500 hover:bg-blue-700 text-white font-bold py-6 px-12 rounded-lg text-3xl shadow-lg text-center flex items-center justify-center min-w-[300px]"
          >
          ...
          <a
            ...
            className="bg-yellow-500 hover:bg-red-700 text-white font-bold py-6 px-12 rounded-lg text-3xl shadow-lg text-center flex items-center justify-center min-w-[300px]"
          >
