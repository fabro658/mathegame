  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-start bg-gray-100 text-gray-900">
      ...
      <div className="flex flex-col gap-4 text-lg w-full pl-0">
        ...
        <a href="/menu/addition" 
        className="hover:underline text-gray-700">
          Addition
        </a>
        <a href="/menu/soustraction" 
        className="hover:underline text-gray-700">
          Soustraction
        </a>
        <a href="/menu/multiplication" 
        className="hover:underline text-gray-700">
          Multiplication
        </a>
        <a href="/menu/division" 
        className="hover:underline text-gray-700">
          Division
        </a>
        <a href="/menu/fraction"
        className="hover:underline text-gray-700">
          Fraction
        </a>
        <a href="/menu/aire" 
        ...
        <a href="/menu/priorite operation" 
        className="hover:underline text-gray-700">
