          ...
          {showExample && (
            <div className="space-y-6 min-h-[400px] flex flex-col justify-between">
              {exampleIndex === 1 && (
                <div>
                  ...
                  <ol className="list-decimal space-y-2 pl-6 text-md">
                    ...
                    <li>
                      On termine avec l&rsquo;addition&nbsp;: 2 + 15 ={" "}
                      <strong>17</strong>
                    </li>
                  </ol>
                </div>
              ...
              {exampleIndex === 2 && (
                <div>
                  ...
                  <ol className="list-decimal space-y-2 pl-6 text-md">
                    ...
                    <li>
                      On termine avec l&rsquo;addition&nbsp;: 9 + 4 ={" "}
                      <strong>13</strong>
                    </li>
                  </ol>
                </div>
              ...
              {exampleIndex === 3 && (
                <div>
                  <h2 className="text-2xl font-bold mb-4">
                    Exemple 3&nbsp;: division et addition
                  </h2>
                  <p className="text-lg mb-2">
                  ...
                  <ol className="list-decimal space-y-2 pl-6 text-md">
                    ...
                    <li>
                      Puis l&rsquo;addition&nbsp;: 4 + 5 = <strong>9</strong>
                    </li>
                  </ol>
                </div>
              )}
              ...
              {exampleIndex === 4 && (
                <div>
                  ...
                  <ol className="list-decimal space-y-2 pl-6 text-md">
                    ...
                    <li>
                      On multiplie par 2&nbsp;: 10 × 2 = <strong>20</strong>
                    </li>
                  </ol>
                </div>
              )}
