...
export default function Multiplication() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-black relative">
      ...
      <Link href="/niveaux/niveau2" className="absolute top-4 right-4 bg-orange-500 text-white py-3 px-8 rounded font-bold">
        Retour
      </Link>
      ...
      <div className="mt-6 flex gap-4">
        {currentPage > 0 && (
          <button className="bg-gray-500 text-white py-2 px-6 rounded font-bold" onClick={handlePreviousPage}>
            Précédent
          </button>
        )}
        ...
        {currentPage < Math.floor(totalQuestions / questionsPerPage) - 1 && (
          <button className="bg-blue-500 text-white py-2 px-6 rounded font-bold" onClick={handleNextPage}>
            Suivant
          </button>
        )}
      </div>
